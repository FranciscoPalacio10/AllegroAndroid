...
import com.example.allegroandroid.ia.VisionProcessorBase;
...
public class PoseDetectorProcessor
    ...
    protected static class PoseWithClassification {
        ...
        private final List<ResultPoseClasifier> classificationResult;

        public PoseWithClassification(Pose pose, List<ResultPoseClasifier> classificationResult) {
            this.pose = pose;
        ...
        public List<ResultPoseClasifier> getClassificationResult() {
        ...
        return detector
                ...
                .continueWith(
                        ...
                        task -> {
                            ...
                            List<ResultPoseClasifier> classificationResult = new ArrayList<>();
