...
public class RepetitionCounter {
  ...
  public RepetitionCounter(ResultPoseClasifier resultPoseClasifier) {
    this(resultPoseClasifier.pose, resultPoseClasifier.confidence, DEFAULT_EXIT_THRESHOLD);
  }

  public RepetitionCounter(String className, double enterThreshold, float exitThreshold) {
  ...
  public int addClassificationResult(ClassificationResult classificationResult) {
    ...
    if (poseConfidence >= enterThreshold) {
      numRepeats++;
      poseEntered = false;
    }
