package com.example.allegroandroid.ui.core.caractersticas;
...
import com.example.allegroandroid.ui.core.adapters.AdpterCaractersticas;
...
public class CaracteristicasFragment extends Fragment {
    ...
    private void llenarRecycler(View v) {
        ...
        ArrayList<CaracteristicasItems> caracteristicasItems = new ArrayList<>();
        recyclerView.setLayoutManager(linearLayoutManager);
        //    caracteristicasItems.add(new CaracteristicasItems(R.drawable.suscrpicion2,"Subscripción"));
        caracteristicasItems.add(new CaracteristicasItems(R.drawable.ic_baseline_star_24, "Puntos Acumulados"));
        ...
        AdpterCaractersticas adaptadorCaractersticas = new AdpterCaractersticas(caracteristicasItems, R.layout.caracteristicasitems, getContext(), mGoogleSignInClient, getActivity());
