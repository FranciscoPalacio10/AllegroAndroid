...
public abstract class AbstractCustomPlayerUiController extends AbstractYouTubePlayerListener {
    ...
    protected Float currentSecond = 0f, timePlayingVideo = 0f, lastSecondWasShowingMenu = 0f, totalVideoSeconds = 0f;
    protected LinearLayout layoutControllers, layoutProgessiveBar, layoutTop;
    protected View playerUi;
    protected DateService dateService;
    protected User user;
    protected ClaseResponse clase;
    protected Activity activity;

    public void setTotalVideoSeconds(Float totalVideoSeconds) {
        this.totalVideoSeconds = totalVideoSeconds;
    }

    public Float getTotalVideoSeconds() {
