...
public class clasesRegistradasLista {
    ...
    public clasesRegistradasLista(String estilo, String nivel, String profesora, String numeroClase, String minuto, String uri, String fecha) {
        this.estilo=estilo;
        this.nivel=nivel;
